...
package fury.mc.launcher.setting

import android.os.Parcelable
import androidx.compose.ui.geometry.Offset
import fury.mc.launcher.setting.unit.AbstractSettingUnit
import fury.mc.launcher.setting.unit.BooleanSettingUnit
import fury.mc.launcher.setting.unit.DEFAULT_FLOAT_RANGE
import fury.mc.launcher.setting.unit.DEFAULT_INT_RANGE
import fury.mc.launcher.setting.unit.DEFAULT_LONG_RANGE
import fury.mc.launcher.setting.unit.FloatSettingUnit
import fury.mc.launcher.setting.unit.IntSettingUnit
import fury.mc.launcher.setting.unit.LongSettingUnit
import fury.mc.launcher.setting.unit.NullableIntSettingUnit
import fury.mc.launcher.setting.unit.OffsetSettingUnit
import fury.mc.launcher.setting.unit.StringListSettingUnit
import fury.mc.launcher.setting.unit.StringSettingUnit
import fury.mc.launcher.setting.unit.enumSettingUnit

...
package fury.mc.launcher.game.download.modpack.platform.curseforge
...
import fury.mc.launcher.game.download.assets.platform.curseforge.models.getPlatformClassesOrNull
import fury.mc.launcher.game.download.assets.platform.curseforge.models.getSHA1
...
import fury.mc.launcher.game.download.modpack.install.ModFile
import fury.mc.launcher.game.download.modpack.install.ModPackInfo
import fury.mc.launcher.game.download.modpack.install.ModPackInfoTask
import fury.mc.launcher.game.download.modpack.platform.PackPlatform

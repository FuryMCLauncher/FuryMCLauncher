...
package fury.mc.launcher.game.download.assets.platform

import android.util.Log
import fury.mc.launcher.game.download.assets.mapExceptionToMessage
import fury.mc.launcher.game.download.assets.platform.curseforge.CurseForgeSearcher
import fury.mc.launcher.game.download.assets.platform.curseforge.MCIM_CURSEFORGE_API
import fury.mc.launcher.game.download.assets.platform.modrinth.MCIM_MODRINTH_API
import fury.mc.launcher.game.download.assets.platform.modrinth.ModrinthSearcher
import fury.mc.launcher.game.download.assets.utils.localizedModSearchKeywords
...
import fury.mc.launcher.utils.network.isInterruptedIOException

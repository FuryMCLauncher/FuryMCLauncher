...
import fury.mc.launcher.database.AppDatabase
import fury.mc.launcher.game.account.auth_server.data.AuthServer
import fury.mc.launcher.game.account.auth_server.data.AuthServerDao
...
object AccountsManager {
    ...
    private fun checkLimit(): Boolean {
        // In FuryMC Launcher, all limits are removed.
        return false
    }

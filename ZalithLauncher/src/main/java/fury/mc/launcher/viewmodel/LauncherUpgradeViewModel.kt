...
import fury.mc.launcher.path.GLOBAL_JSON
import fury.mc.launcher.path.URL_PROJECT_INFO
...
import fury.mc.launcher.ui.upgrade.UpgradeDialog
import fury.mc.launcher.ui.upgrade.UpgradeFilesDialog
...
import fury.mc.launcher.upgrade.GithubContentApi
...
import fury.mc.launcher.utils.string.decodeBase64
        ...
        return withContext(Dispatchers.IO) {
            runCatching {
                ...
                runCatching {
                    ...
                    runCatching {
                        GLOBAL_CLIENT.get(NOTICE_RAW_URL).safeBodyAsJson<RemoteNotice>()
                    }.getOrNull()
                }
            }
        }
            ...
            runCatching {
                ...
                if (Locale.getDefault().language == "zh") {
                    runCatching {
                        ...
                        runCatching {
                            GLOBAL_CLIENT.get(LATEST_RAW_URL).safeBodyAsJson<RemoteData>()
                        }.getOrNull()
                    }
                } else {
                    runCatching {

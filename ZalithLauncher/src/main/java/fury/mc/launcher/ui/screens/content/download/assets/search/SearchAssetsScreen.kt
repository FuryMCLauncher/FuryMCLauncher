...
import fury.mc.launcher.game.download.assets.platform.PlatformDisplayLabel
import fury.mc.launcher.game.download.assets.platform.PlatformFilterCode
import fury.mc.launcher.game.download.assets.platform.PlatformSearchFilter
import fury.mc.launcher.game.download.assets.platform.PlatformSearchResult
import fury.mc.launcher.game.download.assets.platform.navigatePage
import fury.mc.launcher.game.download.assets.platform.nextPage
import fury.mc.launcher.game.download.assets.platform.previousPage
import fury.mc.launcher.game.download.assets.platform.searchAssets
import fury.mc.launcher.game.download.assets.utils.ModTranslations
import fury.mc.launcher.game.download.assets.utils.searchMcMods
import fury.mc.launcher.game.versioninfo.MinecraftVersion
import fury.mc.launcher.game.versioninfo.MinecraftVersions
import fury.mc.launcher.game.versioninfo.popularVersions
...
import fury.mc.launcher.ui.screens.content.download.assets.elements.AssetsPage
import fury.mc.launcher.ui.screens.content.download.assets.elements.ResultListLayout
import fury.mc.launcher.ui.screens.content.download.assets.elements.SearchAssetsState
import fury.mc.launcher.ui.screens.content.download.assets.elements.SearchFilter
